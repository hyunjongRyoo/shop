...
public class CustomerDAO {
	...
	public static ArrayList<HashMap<String, Object>> empCustomerList(int startRow, int rowPerPage)
			throws Exception {
		// currentPage + rowPerpage 로 startRow를 구하는 알고리즘을 dao가 아닌 액션에 구현
		ArrayList<HashMap<String, Object>> customerlist = // list 객체
				new ArrayList<HashMap<String, Object>>();

		Connection conn = DBHelper.getConnection();
		String sql = "select " + "mail,name,birth,gender,update_date updateDate,create_date createDate from customer "
				+ "order by mail " + "offset 0 rows fetch next 10 rows only";
	...
	public static ArrayList<HashMap<String, Object>> selectCustomerOne(String mailParam) throws Exception {
	...
	public static ArrayList<HashMap<String, Object>> paging() throws Exception {
		ArrayList<HashMap<String, Object>> paging = new ArrayList<HashMap<String, Object>>();
